#ifndef __PINS_TMS370C250_H__
#define __PINS_TMS370C250_H__
...
#define ADRL_gp 16    /* P6.16-P6.31 */
#define ADRL_gm 0xFF  /* P6.16-P6.31 */
...
struct PinsTms370C250 final : tms370::PinsTms370 {
    PinsTms370C250();
    ...
    void injectReads(const uint8_t *data, uint_fast8_t len,
            uint_fast8_t extra = 0) override;
