#ifndef __PINS_KL5C80_H__
#define __PINS_KL5C80_H__
...
#define PIN_EMRD 2      /* P9.04 */
#define PIN_EMWR 3      /* P9.05 */
#define PIN_M1 4        /* P9.06 */
#define PIN_EIORD 33    /* P9.07 */
#define PIN_EIOWR 5     /* P9.08 */
#define CNTL_EMRD 0x01  /* CNTL0 */
#define CNTL_EMWR 0x02  /* CNTL1 */
#define CNTL_M1 0x08    /* CNTL2 */
#define CNTL_EIORD 0x10 /* CNTL3 */
#define CNTL_EIOWR 0x20 /* CNTL4 */
#define PIN_CLK 0       /* P6.03 */
#define PIN_ASEL 1      /* P6.02 */
#define PIN_XIN 29      /* P9.31 */
#define PIN_IR0 6       /* P7.10 */
#define PIN_NMI 9       /* P7.11 */
#define PIN_ERDY 32     /* P7.12 */
...
struct PinsKl5c80 final : z80::PinsZ80Base {
    PinsKl5c80();
