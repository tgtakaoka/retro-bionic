...
struct PinsTms9995 final : tms9900::PinsTms9900Base {
    PinsTms9995();
...
private:
    ...
    Signals *resumeCycle(uint16_t pc = 0) const override;
    Signals *prepareCycle() const override;
    Signals *completeCycle(Signals *s) const override;
};

}  // namespace tms9995
}  // namespace debugger
#endif /* __PINS_TMS9995_H__ */
