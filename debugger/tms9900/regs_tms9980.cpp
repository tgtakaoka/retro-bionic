...
RegsTms9980::RegsTms9980(tms9900::PinsTms9900 *pins, Mems *mems)
...
void RegsTms9980::reset() {
    _wp = _mems->read16(tms9900::InstTms9900::VEC_RESET + 0);
    _pc = _mems->read16(tms9900::InstTms9900::VEC_RESET + 2);
}
