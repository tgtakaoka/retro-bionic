...
constexpr auto phi_hi_ns = 400;
constexpr auto clk_lo_ns = 100;
...
Signals *PinsTms9900::prepareCycle() const {
...
Signals *PinsTms9900::completeCycle(Signals *_s) const {
...
Signals *PinsTms9900::resumeCycle(uint16_t pc) const {
    auto s = SignalsTms9900::put();
    s->getAddress();
    s->getControl();
    assert_ready();
