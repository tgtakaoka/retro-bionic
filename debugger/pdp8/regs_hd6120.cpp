...
const Regs::RegList *RegsHd6120::listRegisters(uint8_t n) const {
...
void RegsHd6120::setRegister(uint8_t reg, uint32_t value) {
    switch (reg) {
    case REG_GT:
        set_gt(value);
        break;
    ...
    case REG_SP2:
        ...
        break;
    default:
        RegsPdp8::setRegister(reg, value);
        break;
    }
}
