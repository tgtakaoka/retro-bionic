...
constexpr auto osc1_hi_ns = 100;      // 60
constexpr auto osc1_lo_ns = 100;      // 60
constexpr auto osc1_hi_as = 80;       // 60
constexpr auto osc1_hi_addr = 80;     // 60
constexpr auto osc1_lo_control = 80;  // 60
...
void PinsMc68HC05C0::resetPins() {
    ...
    _mems.raw_write16(vec_reset, 0x1234);
    ...
    // Disable COP, enable IRV and ILRV of CNFGR
    _regs.internal_write(CNFGR, 0x5B); // reset value 0x63
