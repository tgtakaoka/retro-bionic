...
#define EAH_gm 0xFF /* P7.16-P7.19 */
...
struct PinsMc68HC08AZ0 final : mc6805::PinsMc6805 {
    ...
    // TODO
    mc6805::Signals *suspend(mc6805::Signals *s = nullptr) override {
        return s;
    };
...
protected:
    ...
    mc6805::Signals *currCycle(uint16_t pc) const override;
    mc6805::Signals *rawPrepareCycle() override;
    mc6805::Signals *prepareCycle() override { return rawPrepareCycle(); }
